/**
 * Single catch-all Serverless Function (api/[...path].js)
 * Vercel maps ALL /api/* requests to this one file → counts as 1 function only.
 */
import {
  supabase,
  getQuota,
...
function getPath(req) {
  // Vercel catch-all: /api/foo/bar → req.query.path = ['foo','bar']
  ...
  // Fallback: __path from rewrite (e.g. /ai/chat)
