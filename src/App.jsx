...
function drawContent(ctx, type, data, S) {
  ...
  if (type === "hook") {
    ...
    // ── Nama lengkap — kotak hitam solid ────────────────────────────────────
    ...
    parts.forEach((p, i) => {
      ...
      const wordPartW = ctx.measureText((p.word || "") + "  :  ").width;
      ...
      ctx.fillText(p.meaning || "", S/2 - tw/2 + wordPartW, y);
